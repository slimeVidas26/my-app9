...
export const typeDefs = gql`
  ...
  type Mutation {
    ...
    addAlphaOrder(alphaSupplierId: ID!,alphaEdi:Int,alphaReference:Int!, alphaProducts: [AlphaOrderProductInput]!, alphaOrderDate:Date, totalAmount: Float): AlphaOrder
