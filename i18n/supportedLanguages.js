...
Form:"Form" ,
     //warehouse
'46 Foods Raanana':'46 Foods Raanana' ,
'4699 Vegetables Raanana':'4699 Vegetables Raanana',
     //Grid
Arrival:'Arrival' ,
Art:'Art',
Sells:'Sells' ,
...
'Confirmation Of Refund Certificate':'Confirmation Of Refund Certificate',
       //Stock
'Confirmation Of Transfer Certificate': 'Confirmation Of Transfer Certificate',
'Transfer Between Locations':'Transfer Between Locations',
'Internal Order':'Internal Order',
'Transfert Certificate': 'Transfert Certificate',
'Inventory Count':'Inventory Count',
'Stocktaking': 'Stocktaking',
'Locating Item':'Locating Item',
'Locating Location':'Locating Location',
'Cargo Inspection':'Cargo Inspection',
'Confirmation Of Transfer Certificate From Marlog': 'Confirmation Of Transfer Certificate From Marlog',
...
//ChooseRedStampReasonScreen 
     Lack :'Lack',
     Excess: 'Excess',
     'EDI not received':'EDI not received',
     'Invalid code':'Invalid code',
     'Item not ordered':'Item not ordered',
     'Supplier left goods uninspected': 'Supplier left goods uninspected'
...
Form:"פורם",
     //warehouse
'46 Foods Raanana': '46-רעננה' ,
'4699 Vegetables Raanana': '4699-ירקות רעננה',
     //Grid
Arrival : 'רכש' ,
Art : 'אומנות',
Sells: 'מכירות',
...
Suppliers:'ספקים',
        //Arrival
'Express Purchase':'המלצה לרכש אקספרס',
...
'Transfert Certificate': 'תעודת העברה',
...
'Document Review':  "תצוגת מסמכים",
'Deposit Return': 'החזרת פקדון',

//ChooseRedStampReasonScreen 
Lack :'חוסר',
Excess: 'עודף',
'EDI not received':'אי.די.אי (EDI) לא התקבל',
'Invalid code':'קוד לא מתאים',
'Item not ordered':'פריט לא הוזמן',
'Supplier left goods uninspected': 'ספק השאיר סחורה ללא בדיקה'
